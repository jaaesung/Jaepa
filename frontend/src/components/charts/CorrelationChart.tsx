      ...
      <ResponsiveContainer width="100%" height={height}>
        ...
        >
          ...
          <YAxis 
            ...
            orientation="left"
            tick={{ fill: '#1f77b4' }}
            label={{ value: '주가', angle: -90, position: 'insideLeft', fill: '#1f77b4' }}
          />
          <YAxis 
            yAxisId="sentiment"
            domain={[0, 100]}
            ...
            label={{ value: '감성', angle: 90, position: 'insideRight', fill: sentimentColor }}
          />
          {showVolume && (
            <YAxis 
              yAxisId="volume"
          ...
          />
          <Legend payload={[
            { value: '주가', type: 'line', color: '#1f77b4' },
            { value: '감성 점수', type: 'line', color: sentimentColor },
            ...(showVolume ? [{ value: '거래량', type: 'bar', color: '#8884d8' }] : [])
          ]} />
