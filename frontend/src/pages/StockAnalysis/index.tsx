...
const StockAnalysis: React.FC = () => {
  ...
  const [timeRange, setTimeRange] = useState<PeriodType>('1m');
  ...
  return (
    <div className="stock-analysis-container">
      <div className="stock-analysis-header">
        <h1>주식 분석</h1>
        <p className="description">주식 데이터를 분석하고 뉴스 감성과의 상관관계를 확인하세요.</p>
      </div>
      ...
      <div className="stock-analysis-content">
        <div className="stock-sidebar">
          ...
          <div className="watchlist-section">
            <h3>워치리스트</h3>
            <select value={selectedWatchlist} onChange={e => handleWatchlistChange(e.target.value)}>
        ...
        <div className="stock-main-content">
          ...
          <div className="technical-indicators-container">
            ...
            <div className="technical-indicators-grid">
              {sampleTechnicalIndicators
                .filter(indicator =>
                  customIndicators.some(selected => indicator.name.includes(selected))
                )
                .map((indicator, index) => (
          ...
          <div className="stock-analysis-summary">
            ...
            <div className="summary-content">
              <p>
                <strong>기술적 분석:</strong> 이동평균선(SMA)은 상승 추세를 보이고 있으며, RSI
                지표는 68.5로 약간 과매수 상태를 나타내고 있습니다. MACD는 양수 값을 유지하며 상승
                모멘텀을 확인해주고 있습니다.
              </p>
              <p>
                <strong>뉴스 감성 분석:</strong> 최근 7일간의 뉴스 감성은 평균 0.65로 긍정적인
                경향을 보이고 있습니다. 주가와 뉴스 감성 간의 상관계수는 0.72로 강한 양의 상관관계를
                나타내고 있습니다.
              </p>
              <p>
                <strong>거래량 분석:</strong> 거래량은 최근 5일 평균 대비 15% 증가했으며, 가격
                상승과 함께 거래량이 증가하는 건전한 상승 추세를 보이고 있습니다.
              </p>
            </div>
          </div>
        </div>
